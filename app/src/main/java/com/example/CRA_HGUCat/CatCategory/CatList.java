...
public class CatList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 아이템 추가.
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.cat1_36dp), " 나비", " 한동냥 간판담당");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.cat2_36dp), " 깡패", " 맘스 2, 3세대 아빠");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.cat3), " 짬뽕이", " 맘스 2, 3세대 엄마");
